...
class MyColors {
  ...
  static const Color lightBackground = Color(0xFFF4F4FD);
  static const Color lightForeground = Color(0xFFFFFFFF);
  static const Color lightAccentColor = Color(0xFFB4DEF3);
  ...
  static const Color darkAccentColor = Color(0xFF14263D);
